...
Make sure you reference the podcast name when you are discussing its content, but be careful not to repeat podcast name too much. Do not write out the episode title.
...
- **Formatting**: Use <strong></strong> tags to bold podcast show names. DO NOT use asterisks instead of <strong> tags to bold podcast show names. DO NOT write episode titles. ONLY write episode titles if you don't have the podcast name itself.
