    ...
    <tr>
      <td style="padding:20px;">
        ...
        <ul style="padding-left: 20px; line-height: 1.6;">
          <li>Major AI regulation changes in Europe</li>
          <li>Dating apps are getting weirder</li>
          <li>Quantum computing breakthrough at MIT</li>
        </ul>
        ...
        <p style="line-height:1.6;margin-bottom:20px;"><em>P.S. Got feedback or want to unsubscribe? Hit reply to this email and let me know.</em></p>
      </td>
    </tr>
  </table>
</body>
...
describe('validateNewsletterStructure', () => {
  ...
  it('detects missing required sections', () => {
    const invalidHtml = `<!DOCTYPE html><html lang="en"><head><style>@media (prefers-color-scheme: dark) {}</style></head><body><h1>Test</h1></body></html>`
